...
public class NugetParserHelper {

    private NugetParserHelper() {
        // do nothing
    }

    public static NugetModel parse(InputStream inputStream) throws ReportParserException {
        ObjectMapper mapper = new XmlMapper();
        try {
            return mapper.readValue(inputStream, NugetModel.class);
